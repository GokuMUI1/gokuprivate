    ...
    def Porsche(self):
        try:
            ...
            if r.status_code == 302:
                print(f"{Fore.LIGHTGREEN_EX}[:ɔ] {Style.RESET_ALL}attim Goku#0005")
                self.adet += 1
            else:
                raise 
        except:
            print(f"{Fore.LIGHTRED_EX}[:c] {Style.RESET_ALL}atamadim nt Goku#0005")
    ...
    def Vajini(self):
        try:
            ...
            if r.status_code == 303:
                print(f"{Fore.LIGHTGREEN_EX}ez {Style.RESET_ALL}attim Goku#0005")
                self.adet += 1
            else:
                raise 
        except:
